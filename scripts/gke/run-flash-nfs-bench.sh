...
VM_NAME="nfs-flash"
JOB_NAME="mimo-v2-flash-1node-nfs-tpu7"
READY_FLAG="gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-ready"
NFS_IP_FLAG="gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-ip"
...
kubectl apply -f "${SCRIPT_DIR}/mimo-v2-flash-1node-nfs-tpu7.yaml"
