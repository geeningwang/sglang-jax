...
VM_NAME="nfs-flash-vara"
JOB_NAME="mimo-v2-flash-1node-nfs-tpu7-vara"
READY_FLAG="gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-vara-ready"
NFS_IP_FLAG="gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-vara-ip"
...
kubectl apply -f "${SCRIPT_DIR}/mimo-v2-flash-1node-nfs-tpu7-vara.yaml"
...
echo "${INTERNAL_IP}" | gsutil cp - \
  gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-vara-ip

# Signal readiness — main script and GKE pod poll for this flag.
echo "ready at $(date -u) ip=${INTERNAL_IP}" | gsutil cp - \
  gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-vara-ready
