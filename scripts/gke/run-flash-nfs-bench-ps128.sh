...
VM_NAME="nfs-flash-ps128"
JOB_NAME="mimo-v2-flash-1node-nfs-tpu7-ps128"
READY_FLAG="gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-ps128-ready"
NFS_IP_FLAG="gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-ps128-ip"
...
kubectl apply -f "${SCRIPT_DIR}/mimo-v2-flash-1node-nfs-tpu7-ps128.yaml"
...
echo "${INTERNAL_IP}" | gsutil cp - \
  gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-ps128-ip

# Signal readiness — main script and GKE pod poll for this flag.
echo "ready at $(date -u) ip=${INTERNAL_IP}" | gsutil cp - \
  gs://jingnw-mimo-v2-flash-us-central1/nfs-flash-ps128-ready
